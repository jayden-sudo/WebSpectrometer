...
Um aplicativo de espectrômetro DIY — um fork do [Theremino Spectrometer](https://www.theremino.com/en/downloads/automation#spectrometer) V5.0 que roda no navegador.

**▶ Experimente agora: [spectrometer-web.vercel.app](https://spectrometer-web.vercel.app/)** — sem instalação, basta abrir em um navegador baseado em Chromium (Chrome, Edge, Opera…).

🔒 **Privacidade**: todo o processamento de imagem acontece localmente no seu navegador — nenhum dado é enviado.
...
Principais funcionalidades: pipeline de filtragem em tempo real (média, velocidade de subida/descida, média espacial, referência/fundo), detecção de picos e vales com rótulos, coloração por comprimento de onda, escala logarítmica, correção de irradiância e interface em 6 idiomas. Funciona em qualquer navegador baseado em Chromium (Chrome, Edge, Opera…); Firefox e Safari não são compatíveis por não possuírem Web Serial.
...
Este aplicativo usa deliberadamente o domínio gratuito do Vercel — [spectrometer-web.vercel.app](https://spectrometer-web.vercel.app/) — em vez de um domínio próprio: receio que, daqui a alguns anos, eu esqueça de renovar um domínio comprado e todos os links para este projeto deixem de funcionar silenciosamente; o subdomínio gratuito, por outro lado, permanece ativo enquanto o projeto existir. Dito isso, se alguém quiser oferecer um domínio curto, ficarei muito feliz — [mande-me uma DM](https://x.com/jayden_sudo).

## Licença

GNU GPL v3. Este projeto é um fork independente, baseado em navegador, do Theremino Spectrometer V5.0 e não é afiliado ao Theremino System.

## Agradecimentos

Agradecimentos especiais a [www.theremino.com](https://www.theremino.com) — o projeto Theremino publica generosamente todo o seu código-fonte e documentação sob uma política de "No Copyright". Sem o seu trabalho extraordinário em instrumentos científicos de código aberto, este projeto não existiria.
